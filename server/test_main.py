...
def post_helper(endpoint: str, force: bool, file: FileIO):
    ...
    files = {"file": file}
    payload ={"email_index": 0, "first_name_index": 0, "last_name_index": 0, "force": force, "has_headers": True}
...
def upload_helper(endpoint: str, force: bool):
    ...
    write_data = schemas.UploadWriteRequest(upload_id=32, file_name="prospects.csv", force=force, has_headers=True)
